...
const createBoard = (projectId, data, headers) => socket.post(`/projects/${projectId}/boards`, data, headers).then((body) => ({
  ...body,
  included: {
    ...body.included,
...
// const getBoard = (id, subscribe, headers) => socket
//   .get(`/boards/${id}${subscribe ? '?subscribe=true' : ''}`, undefined, headers)
//   .then((body) => {
//     console.log('Body Data:', body); // Log the body
//     return {
//       ...body,
//       included: {
//         ...body.included,
