...
export default {
  ...
  translation: {
    common: {
      ...
      createNewOneOrSelectExistingOne: 'یک برد جدید ایجاد کرده یا<br />یک مورد را انتخاب کنید.',
    ...
    action: {
      ...
      showFewerAttachments: 'نمایش پیوست‌های کمتر',
      sortList_title: 'مرتب‌سازی لیست',
      start: 'شروع',
      stop: 'توقف',
      subscribe: 'مشترک شدن',
